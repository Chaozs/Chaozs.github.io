    ...
    const workExperiences = [
      {
        ...
        details: [
          "Led development of Skillfite.io, a live-service web-based MMORPG with 1000+ daily users.",
          ...
          "Led product standups, bi-weekly sprint planning, sprint reports, and retro reports using Jira.",
